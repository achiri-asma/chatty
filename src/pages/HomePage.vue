      ...
      <div class="h-[600px] rounded-b-xl border-2 border-t-0 border-customGreen">
        ...
        <div class="bg-white h-[48px] rounded-b-xl flex items-center justify-between px-4">
          ...
          <div v-if="selectedItem" class="flex items-center w-full">
            ...
            <div class="flex items-center ">
              <img class="w-8 h-8 md:w-6 md:h-6 rtl-flip flex items-center justify-center" src="../assets/chat.png" alt="send">

<img class="w-8 h-8 md:w-6 md:h-6 cursor-pointer rtl-flip flex items-center justify-center" src="../assets/select.png" @click="toggleDropdown" alt="select">
